...
try 
{
    $options = array( 'location' => 'http://servicoshm.saude.gov/cadsus/AuditoriaCadsusService/v5r0', 
                    'encoding' => 'utf-8', 
    ...
    $client = new SoapClient('https://servicoshm.saude.gov.br/cadsus/AuditoriaCadsusService/v5r0?wsdl', $options);   
    $client->__setSoapHeaders(soapClientWSSecurityHeader('CADSUS.CNS.PDQ.PUBLICO', 'kUXNmiiii#RDdlOELdoe00966'));

    $function = 'obterUltimaDataAlteracaoUsuarioSUS';
